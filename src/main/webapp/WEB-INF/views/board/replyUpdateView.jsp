...
<nav class="navbar navbar-default">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				location.href = "boardRead?bno=${replyUpdate.bno}"
					   + "&page=${scri.page}"
	...
	<section id="container">
		<form name="updateForm" role="form" method="post" action="replyUpdate">
			...
			<div>
				<button type="submit" class="update_btn btn btn-Light">저장</button>
				<button type="button" class="cancel_btn btn btn-Light">취소</button>
			</div>
		</form>
	</section>
